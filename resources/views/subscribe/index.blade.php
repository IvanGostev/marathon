    ...
    <div class="container py-12">
        <header>
            <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
                <h1 class="display-4 fw-normal text-body-emphasis">Подписки</h1>
                <br>
                @if(auth()->user()->checkSubscribe())
                    <div class="alert alert-success text-center mb-4">
                        <h4 class="alert-heading">Подписка активна!</h4>
                        <p>Ваша подписка действует до
                            {{ \Carbon\Carbon::parse(auth()->user()->subscribe_date)->format('d.m.Y') }}</p>
                    </div>
                @else
            ...
            <div class="row row-cols-1 row-cols-md-3 mb-3 text-center" style="justify-content: center;">
                <div class="col">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        <div class="card-header py-3">
                            <h4 class="my-0 fw-normal">«Базовый»</h4>
                        </div>
                        <div class="card-body">
                            <h1 class="card-title pricing-card-title">1900 ₽<small
                            ...
                            <span onclick="getModal('base')" data-bs-toggle="modal" data-bs-target="#subscribeModal"
                                href="#" class="w-100 btn btn-lg btn-primary">Оплатить</span>
                ...
                @if (checkWinner(false))
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div class="card-header py-3">
                                <h4 class="my-0 fw-normal">«Победитель»</h4>
                            </div>
                            <div class="card-body">
                                <h1 class="text-success fw-bold card-title pricing-card-title">950
                                    ₽<small class="text-body-secondary fw-light">/ мес</small></h1>
                                <ul class="list-unstyled mt-3 mb-4">
                                    <li>Доступ к обучающим материалам (видеоуроки)</li>
                                    <li>Доступ к онлайн-платформе «Бриллиантовая Читка (Брю-Ч)»</li>
                                    <li>Ежедневная взаимная поддержка:
                                ...
                                <span onclick="getModal('winner')" data-bs-toggle="modal" data-bs-target="#subscribeModal"
                                    href="#" class="w-100 btn btn-lg btn-primary">Оплатить</span>
                                {{-- href="{{route('payment', ['subscribe' => 'base', 'user' => auth()->user()->id])}}"--}}
                            </div>
                        </div>
                ...
                @if (checkWinner(true))
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div class="card-header py-3">
                                <h4 class="my-0 fw-normal">«Чемпион»</h4>
                            </div>
                            <div class="card-body">
                                <h1 class="text-success fw-bold card-title pricing-card-title">190
                                    ₽<small class="text-body-secondary fw-light">/ мес</small></h1>
                                <ul class="list-unstyled mt-3 mb-4">
                                    <li>Доступ к обучающим материалам (видеоуроки)</li>
                                    <li>Доступ к онлайн-платформе «Бриллиантовая Читка (Брю-Ч)»</li>
                                ...
                                <span onclick="getModal('champion')" data-bs-toggle="modal" data-bs-target="#subscribeModal"
                                    href="#" class="w-100 btn btn-lg btn-primary">Оплатить</span>
                                {{-- href="{{route('payment', ['subscribe' => 'base', 'user' => auth()->user()->id])}}"--}}
                            </div>
                        </div>
